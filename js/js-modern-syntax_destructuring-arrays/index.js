...
console.log("first name of Chris: ", firstNameOfChris);
console.log("last name of Chris: ", lastNameOfChris);
...
console.log("last name of Alex: ", lastNameOfAlex);
console.log("first name of Alex: ", firstNameOfAlex);
// EXERCISE 4
